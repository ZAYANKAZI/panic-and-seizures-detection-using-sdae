...
# this is our final denoising autoencoder architecture with single convolution block with batchnorm and relu
...
class DenoisingAutoencoder(nn.Module):
    def __init__(
        ...
        self.encoder = nn.Sequential(
            nn.Conv2d(
                input_channels, encoded_channels, kernel_size=3, stride=2, padding=1
            ),
